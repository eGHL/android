...
# **Change Log** 
### [**v2.5.4](https://github.com/eGHL/android/releases/tag/v2.5.4)
* Implemented EMandate

### [**v2.5.3](https://github.com/eGHL/android/releases/tag/v2.5.3)
* Added CustID parameter

### [**v2.5.2](https://github.com/eGHL/android/releases/tag/v2.5.2)
* Include Javascript to remove Popup in WebView

### [**v2.5.1](https://github.com/eGHL/android/releases/tag/v2.5.1)
* Update dependencies and deprecated class

### [**v2.5.0](https://github.com/eGHL/android/releases/tag/v2.5.0)
* Migrate to AndroidX

### [**v2.4.7](https://github.com/eGHL/android/releases/tag/v2.4.7)
* Created setQueryHashValue params to prioritize query HashValue when .setPassword() is not used 

### [**v2.4.6](https://github.com/eGHL/android/releases/tag/v2.4.6)
* Fixed Amount issue when the device's language is set to Indonesia 

### [**v2.4.5](https://github.com/eGHL/android/releases/tag/v2.4.5)
* Fixed JavaScript console issue
* Fixed CardPage validation issue
* Excluded QueryCount from payment URL

### [**v2.4.4](https://github.com/eGHL/android/releases/tag/v2.4.4)
* Fixed decimal formatter bug
* Added QueryCount parameter

### [**v2.4.3](https://github.com/eGHL/android/releases/tag/v2.4.3)
* Enhanced SSL certificate error URL exclusion

### [**v2.4.2](https://github.com/eGHL/android/releases/tag/v2.4.2)
* Enchanced eGHL Optimize 
* Added URL SSL certificate error exclusion

### [**v2.4.1](https://github.com/eGHL/android/releases/tag/v2.4.1)
* Disable popup webview in staging environment

### [**v2.4.0](https://github.com/eGHL/android/releases/tag/v2.4.0)
* Introduce eGHL Optimize
* Fixed cardPan validation error in card page

### [**v2.3.5](https://github.com/eGHL/android/releases/tag/v2.3.5)
* Update card page to retrieve tokenized card.

### [**v2.3.4](https://github.com/eGHL/android/releases/tag/v2.3.4)
* Allow merchant to send HashValue.

### [**v2.3.3](https://github.com/eGHL/android/releases/tag/v2.3.3)
...
### [**v2.3.2](https://github.com/eGHL/android/releases/tag/v2.3.2)
* Fixed issue wrong card format display when user edit in the middle of the card. 

### [**v2.3.1](https://github.com/eGHL/android/releases/tag/v2.3.1)
...
### [**v2.3](https://github.com/eGHL/android/releases/tag/v2.3)
* Added card UI

### [**v2.2.10](https://github.com/eGHL/android/releases/tag/v2.2.10)
...
### [**v2.2.9](https://github.com/eGHL/android/releases/tag/v2.2.9)
...
### [**v2.2.8](https://github.com/eGHL/android/releases/tag/v2.2.8)
* Added delayed exit when user exits while SDK is processing the 2nd MPE request.

### [**v2.2.7](https://github.com/eGHL/android/releases/tag/v2.2.7)
...
### [**v2.2.6](https://github.com/eGHL/android/releases/tag/v2.2.6)
* Prevent exit on masterpass express payment when gateway is not yet loaded

### [**v2.2.5](https://github.com/eGHL/android/releases/tag/v2.2.5)
...
### [**v2.2.4](https://github.com/eGHL/android/releases/tag/v2.2.4)


* Fix for issue #4: SDK crashing when MerchantReturnURL has a query strings

### [**v2.2.3](https://github.com/eGHL/android/releases/tag/v2.2.3)
* Removed retry policy in all transactions


### [**v2.2.2](https://github.com/eGHL/android/releases/tag/v2.2.2)
* Fixed issue #1 Crash when triggering capture


### [**v2.2.1](https://github.com/eGHL/android/releases/tag/v2.2.1)
...
### [**v2.2.0](https://github.com/eGHL/android/releases/tag/v2.2.0)
...
### [**v2.1.8](https://github.com/eGHL/android/releases/tag/v2.1.8)
* added support to set the gateway in java instead of setting it in android manifest

### [**v2.1.7](https://github.com/eGHL/android/releases/tag/v2.1.7)
...
### [**v2.1.6](https://github.com/eGHL/android/releases/tag/v2.1.6)
* added instant status instead of doing requery same like iOS behaviour

### [**v2.1.5](https://github.com/eGHL/android/releases/tag/v2.1.5)
...
### [**v2.1.4](https://github.com/eGHL/android/releases/tag/v2.1.4)
...
### [**v2.1.0](https://github.com/eGHL/android/releases/tag/v2.1.0)
